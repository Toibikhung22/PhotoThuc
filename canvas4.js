document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.endsWith("canvas4.html") || window.location.pathname === "canvas4.html") {
        startCamera();
    }
    ...
    function handleImageUpload(event) {
        ...
        if (images.length >= 4) {
            const confirmReplace = confirm("You already have 4 pictures. Uploading a new image will replace all current pictures. Do you want to proceed?");
