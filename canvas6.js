document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.endsWith("canvas6.html") || window.location.pathname === "canvas6.html") {
        startCamera();
    }
    ...
    function handleImageUpload(event) {
        ...
        if (images.length >= 6) {
            const confirmReplace = confirm("You already have 6 pictures. Uploading a new image will replace all current pictures. Do you want to proceed?");
        ...
        images.forEach((imgData, index) => {
            ...
            img.onload = () => {
                ...
                if (loadedImages === 6) { 
                    ...
                    window.location.href = 'customize6.html'; 
                }
            };
        });
    }
